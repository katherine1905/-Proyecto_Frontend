    ...
    <nav id="menu"> 
        ...
        <nav class="navbar navbar-light ">
            <form class="form-inline">
              ...
              <button class="btn-Resumen btn-outline-success my-2 my-sm-0" type="submit">Buscar</button>
            </form>
          </nav>
                    ...
                    <form class="input-group">
                        <div class=" search-dos">
                           ...
                           <input  type="" class="input-field-dos" placeholder="    Costo Total" > 
                            ...
                            <a href="http://supertickets.test/" class="btn-Registro2 btn-Registro2- dafault"> Aceptar</a>
